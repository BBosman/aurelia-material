...
var _materialDesignLite = require('google/material-design-lite');
...
function upgradeElement(element, type) {
  ...
  try {
    for (var _iterator2 = js[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      var jsType = _step2.value;
      _materialDesignLite.componentHandler.upgradeElement(element, jsType);
    }
  } catch (err) {
...
var MDLCustomAttribut = exports.MDLCustomAttribut = (_dec = (0, _aureliaFramework.inject)(Element), _dec2 = (0, _aureliaFramework.customAttribute)('mdl'), _dec(_class = _dec2(_class = function () {
